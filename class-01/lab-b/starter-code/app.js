...
// Shows the content of Joe Object using this in the scope function
// 2. What is "this" when joe.scopeArrow() is invoked?
// Gives null exception, this is not available if function was declared with an arrow 
// 3. Explain why "this" is different when an arrow function is used.
// Looks like this scope is not available for arrow functions and available for functions declared with function
